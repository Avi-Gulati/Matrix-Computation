...
int** strassen(int** A, int** B, int n, int n0) {
    ...
    int** p1 = strassen(a, matrix_subtraction(f,h,padding), padding, 1);
    int** p2 = strassen(matrix_addition(a,b,padding), h, padding, 1);
    int** p3 = strassen(matrix_addition(c,d,padding), e, padding, 1);
    int** p4 = strassen(d, matrix_subtraction(g,e,padding), padding, 1);
    int** p5 = strassen(matrix_addition(a,d,padding), matrix_addition(e,h,padding), padding, 1);
    int** p6 = strassen(matrix_subtraction(b,d,padding), matrix_addition(g,h,padding), padding, 1);
    int** p7 = strassen(matrix_subtraction(c,a,padding), matrix_addition(e,f,padding), padding, 1);
