...
int** strassen(int** A, int** B, int n, int n0) {
    ...
    int** p1 = strassen(a, matrix_subtraction(f,h,ndiv_2), ndiv_2, n0);
    int** p2 = strassen(matrix_addition(a,b,ndiv_2), h, ndiv_2, n0);
    int** p3 = strassen(matrix_addition(c,d,ndiv_2), e, ndiv_2, n0);
    int** p4 = strassen(d, matrix_subtraction(g,e,ndiv_2), ndiv_2, n0);
    int** p5 = strassen(matrix_addition(a,d,ndiv_2), matrix_addition(e,h,ndiv_2), ndiv_2, n0);
    int** p6 = strassen(matrix_subtraction(b,d,ndiv_2), matrix_addition(g,h,ndiv_2), ndiv_2, n0);
    int** p7 = strassen(matrix_subtraction(c,a,ndiv_2), matrix_addition(e,f,ndiv_2), ndiv_2, n0);
...
int main(int _argc, char *argv[]) {
    ...
    for (int i = 0; i < numberOfBaseCases; i++) {
        ...
        int** product2 = strassen(matrix1, matrix2, nextPowerOfTwo, crossover);
    ...
    auto start = std::chrono::high_resolution_clock::now();
    //int** product2 = strassen(matrix1, matrix2, nextPowerOfTwo, 8);
    auto end = std::chrono::high_resolution_clock::now();
    auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
